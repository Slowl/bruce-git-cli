...
import { pullAndRebaser, push } from '../branch/index.js'
...
export const create = async ({ r, p }: { r?: boolean, p?: boolean }) => {
	...
	userWantToPush.should_push && await push({ b: currentBranch, displayMessage: false })

	return { gitCommitMessage, currentBranch }
}
